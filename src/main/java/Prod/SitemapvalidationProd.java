...
public class SitemapvalidationProd {

    public static void main(String[] args) {
        String sitemapUrl = "https://jswonemsme.com/sitemap.xml"; // Replace with your sitemap URL
    ...
    private static void generatePDFReport(List<UrlStatus> urlStatusList, int totalUrls) {
        try {
            ...
            String outputPath = "target/PDF Report/sitemap_validation_Prod_report.pdf";
